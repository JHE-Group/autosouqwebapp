...
/**
 * The single contact affordance for a listing.
 *
 * NICHE.md makes one WhatsApp tap a core promise, and Property Finder's UAE
 * pilot found WhatsApp leads were additive rather than cannibalising calls —
 * so where a phone number exists we keep a tel: link beside it.
 */
export default function WhatsAppButton({
  ...
  // No usable number — render nothing rather than a dead "#" link.
  if (!href) return null;
  ...
  if (variant === "icon") {
    return (
      <a
        ...
        style={{ ...WHATSAPP_BUTTON_STYLE, width: 48, minWidth: 48 }}
      >
