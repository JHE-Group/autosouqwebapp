...
export interface ApiBodyTypeBodyType extends Struct.CollectionTypeSchema {
...
export interface ApiCarColorCarColor extends Struct.CollectionTypeSchema {
...
export interface ApiCityCity extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Oman cities for listing location';
    displayName: 'City';
    pluralName: 'cities';
    singularName: 'city';
  };
...
export interface ApiConditionCondition extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'New / Used / Certified';
...
export interface ApiFeatureFeature extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Car amenities / features';
    displayName: 'Feature';
    pluralName: 'features';
...
export interface ApiListingListing extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Car listing for Autosouq.om';
    displayName: 'Listing';
    pluralName: 'listings';
  ...
  attributes: {
    ...
    color: Schema.Attribute.Relation<'manyToOne', 'api::car-color.car-color'>;
    ...
    importOrigin: Schema.Attribute.Enumeration<
      ['gcc', 'us-import', 'japan-import', 'other']
    >;
    ...
    make: Schema.Attribute.Relation<'manyToOne', 'api::make.make'>;
...
export interface ApiMakeMake extends Struct.CollectionTypeSchema {
  collectionName: 'makes';
  info: {
    description: 'Car manufacturer (Toyota, Nissan, etc.)';
    displayName: 'Make';
    pluralName: 'makes';
    singularName: 'make';
  };
  ...
  attributes: {
    ...
    listings: Schema.Attribute.Relation<'oneToMany', 'api::listing.listing'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::make.make'> &
      Schema.Attribute.Private;
...
export interface ApiModelModel extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Car model under a make';
    displayName: 'Model';
    pluralName: 'models';
    singularName: 'model';
  };
...
export interface PluginUsersPermissionsUser
  ...
  info: {
    description: 'End-user accounts for Autosouq sellers and buyers';
    displayName: 'User';
    name: 'user';
    pluralName: 'users';
    singularName: 'user';
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::car-color.car-color': ApiCarColorCarColor;
